...
With 49 providers and thousands of datasets between them, the hard part is often not downloading — it is working
...
1. **`find("precipitation")`** — narrow 49 providers to a handful.
