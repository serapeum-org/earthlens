...
_ROWS = [
    {
        ...
        "grid_label": "gn",
        "version": 20190101,
        "zstore": "gs://cmip6/CanESM5/ssp585/tas/gn/v20190101/",
        "dcpp_init_year": None,
    },
    {
        "activity_id": "ScenarioMIP",
        ...
        "grid_label": "gn",
        "version": 20190429,
        "zstore": "gs://cmip6/CanESM5/ssp585/tas/gn/v20190429/",
        "dcpp_init_year": None,
    },
    {
        "activity_id": "ScenarioMIP",
        ...
        "grid_label": "gr",
        "version": 20190429,
        "zstore": "gs://cmip6/CanESM5/ssp585/tas/gr/v20190429/",
        "dcpp_init_year": None,
    },
    {
        "activity_id": "ScenarioMIP",
        ...
        "grid_label": "gn",
        "version": 20190429,
        "zstore": "gs://cmip6/CanESM5/ssp585/tas/gn-r2/v20190429/",
        "dcpp_init_year": None,
    },
    {
        "activity_id": "CMIP",
        ...
        "grid_label": "gn",
        "version": 20190429,
        "zstore": "gs://cmip6/CanESM5/historical/tas/gn/v20190429/",
        "dcpp_init_year": None,
    },
    {
        "activity_id": "ScenarioMIP",
        ...
        "grid_label": "gr1",
        "version": 20180701,
        "zstore": "gs://cmip6/GFDL-ESM4/ssp585/pr/gr1/v20180701/",
        "dcpp_init_year": None,
    },
]
...
class FakeLabeled:
    ...
    def select_time(
        self, start: Any = None, end: Any = None, *, time_dim: str = "time"
    ) -> FakeLabeled:
