    ...
    Examples:
        - Inspect the registered backends:
            ...
            ['admin', 'admin-boundaries', 'airnow', 'alaska-satellite-facility',
             'amazon-s3', 'argo', 'argo-floats', 'argopy', 'asf',
             'bare-earth-dem', 'bathymetry',
             ...
             'isric', 'iucn', 'jaxa', 'jaxa-earth', 'jrc-flood', 'jrc-flood-hazard',
             'landsat',
             'mswep', 'mswx',
             'national-water-model', 'natural-earth', 'nexrad', 'nfhl',
             'nfip', 'nrel', 'nsi', 'nsrdb', 'nwis', 'nwm', 'nwp', 'obis',
             'ohsome', 'openaq',
